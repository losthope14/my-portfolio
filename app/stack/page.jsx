...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Basthian Arisna",
    },
    {
      fieldName: "Phone",
      fieldValue: "(+62) 852 5626 0040",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "bastianarisna@gmail.com",
    },
    {
      fieldName: "Freelance",
          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="about" className="w-full text-center xl:text-left">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[750px] mx-auto xl:mx-0 bg-[#232329] rounded-xl py-6 px-6">
